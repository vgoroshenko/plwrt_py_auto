...
def test_go_to_page(page):
    page = DynamicallyLoaded(page)
    page.go_to_page()
    page.should_be_correct_page()

def test_first_example_show_load_bar(page):
    page = DynamicallyLoaded(page)
    page.go_to_page()
...
def test_first_example_final_text_present(page):
    page = DynamicallyLoaded(page)
    page.go_to_page()
    page.click_example_1()
    page.click_start()
...
def test_second_example_show_load_bar(page):
    page = DynamicallyLoaded(page)
    page.go_to_page()
...
def test_second_example_final_text_present(page):
    page = DynamicallyLoaded(page)
    page.go_to_page()
    page.click_example_2()
    page.click_start()
