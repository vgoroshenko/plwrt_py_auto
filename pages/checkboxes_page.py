...
class Checkboxes(BasePage):
    ...
    def go_to_page(self):
        link = self.page.locator(CheckboxesLocators.CHECKBOXES_PAGE)
        link.click()

    def press_first_checkbox(self):
        button = self.page.locator(CheckboxesLocators.FIRST_CHECKBOX)
        button.click()

    def press_second_checkbox(self):
        button = self.page.locator(CheckboxesLocators.SECOND_CHECKBOX)
        button.click()
