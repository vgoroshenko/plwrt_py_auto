...
class FileUploader(BasePage):
    ...
    def go_to_page(self):
        link = self.page.locator(FileUploadLocators.LOADED_PAGE)
        link.click()

    def click_upload(self):
        submit_button = self.page.locator(FileUploadLocators.FILE_SUBMIT)
        submit_button.click()
    ...
    def drag_and_drop_file(self):
        ...
        return input;
        """
        upload_element = self.page.locator(FileUploadLocators.FILE_UPLOAD_DRAG_AND_DROP)
        self.page.evaluate(JS_DROP_FILE)
        path = './tests/test_data/some-file.txt'
        #file_input.send_keys(path)

    def upload_file(self):
        file_input = self.page.locator(FileUploadLocators.FILE_UPLOAD)
        file_input.set_input_files('./tests/test_data/some-file.txt')
        self.click_upload()
